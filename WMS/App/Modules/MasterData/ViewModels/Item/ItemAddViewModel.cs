...
{
    public class ItemAddViewModel : DetailsViewModel<ItemDetails>, IRefreshDataEntityViewModel, IEdit
    {
        #region Fields
...
#pragma warning restore S125 // Sections of code should not be commented out
        ...
        {
            get => this.showAddView;
            set => this.SetProperty(ref this.showAddView, value);
        }
        ...
        {
            var data = this.Data;
            this.DialogService.ShowMessage("Ciao", "come");
            if (data is ItemsViewModel)
            {
