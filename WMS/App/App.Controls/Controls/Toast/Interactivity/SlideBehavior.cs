...
namespace Ferretto.WMS.App.Controls
{
    ...
    public sealed class SlideBehavior : Behavior<FrameworkElement>
    {
        ...
        public void SlideIn()
        {
            ...
            var storyboard = GetSlideInStoryboard(this.BeginTime, this.Duration, this.Offset);
        ...
        public void SlideOut()
        {
            ...
            var storyboard = GetSlideOutStoryboard(this.BeginTime, this.Duration, this.Offset);
            EventHandler eventHandler = null;
            eventHandler = (sender, e) =>
            {
                storyboard.Completed -= eventHandler;
        ...
        {
            var eventHandler = this.SlideInCompleted;
        ...
        {
            var eventHandler = this.SlideOutCompleted;
