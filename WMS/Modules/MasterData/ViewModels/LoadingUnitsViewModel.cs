...
{
    public class LoadingUnitsViewModel : BaseNavigationViewModel
    {
        #region Fields

        private readonly IDataSourceService filterService = ServiceLocator.Current.GetInstance<IDataSourceService>();
        private IDataSource<LoadingUnit> selectedDataSource;
        ...
        public IEnumerable<IDataSource<LoadingUnit>> DataSources =>
            this.filterService.GetAll(MvvmNaming.GetViewNameFromViewModelName(nameof(LoadingUnitsViewModel))) as IEnumerable<IDataSource<LoadingUnit>>;
        ...
        public IDataSource<LoadingUnit> SelectedDataSource
        {
