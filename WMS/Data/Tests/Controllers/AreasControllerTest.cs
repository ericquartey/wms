...
namespace Ferretto.WMS.Data.Tests
{
    ...
    public class AreasControllerTest : BaseControllerTest
    {
        ...
        [TestMethod]
        public async Task GetAisles_Found()
        {
            #region Arrange
        ...
        [TestMethod]
        public async Task GetAisles_NotFound()
        {
            #region Arrange
        ...
        [TestMethod]
        public async Task GetBaysAsync_Found()
        {
            #region Arrange
        ...
        [TestMethod]
        public async Task GetBaysAsync_NotFound()
        {
            #region Arrange
        ...
        [TestMethod]
        public async Task GetCellsAsync_Found()
        {
            #region Arrange
        ...
        [TestMethod]
        public async Task GetCellsAsync_NotFound()
        {
            #region Arrange
