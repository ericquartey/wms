...
{
    public partial class ItemListsControllerTest
    {
        #region Methods
        ...
        public async Task CreateAsync_WithNotifications()
        {
            ...
            var itemList1 = new ItemListDetails
            {
                Code = "Item List #1",
                Priority = 1,
            ...
            await controller.CreateAsync(itemList1);
            ...
            Assert.IsTrue(
                notificationService
                    .SentNotifications
                    .Any(
                        n => n.ModelType == typeof(ItemListDetails)
        ...
        public async Task DeleteAsync_WithNotifications()
        {
            ...
            await controller.DeleteAsync(itemList1.Id);
                ...
                notificationService
                    ...
                    .Any(
                        n => n.ModelId == itemList1.Id.ToString()
                            && n.ModelType == typeof(ItemListDetails)
        ...
        public async Task ExecuteAsync_WithNotifications()
        {
            ...
            await controller.ExecuteAsync(itemList1.Id, this.Area1.Id, this.Bay1.Id);
        ...
        public async Task UpdateAsync_WithNotifications()
        {
            ...
            var itemListResult = await controller.GetByIdAsync(itemList1.Id);
            var itemListToBeUpdated = (ItemListDetails)((OkObjectResult)itemListResult.Result).Value;
            itemListToBeUpdated.Priority = 10;

            #endregion

            #region Act

            await controller.UpdateAsync(itemListToBeUpdated, itemList1.Id);
