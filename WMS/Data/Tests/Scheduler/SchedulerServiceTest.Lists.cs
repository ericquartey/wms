...
namespace Ferretto.WMS.Data.Tests.Scheduler
{
    public partial class SchedulerServiceTest
    {
        ...
        public async Task ExecuteListAsync_NewState()
        {
            #region Arrange
        ...
        public async Task ExecuteListAsync_WithAndWithoutPriority()
        {
            #region Arrange
        ...
        [TestProperty(
         ...
         @"GIVEN a new list with prioritized rows \
             ...
             THEN  a new set of requests is generated
             AND   the generated missions have as priority the sum of the row's priority and of the bay")]
        public async Task ExecuteListAsync_WithPriority()
        {
            #region Arrange
        ...
        public async Task ExecuteListRowAsync_WithPriority()
        {
            #region Arrange
            ...
            await schedulerService.ExecuteListRowAsync(row1.Id, this.Bay1Aisle1.AreaId, this.Bay1Aisle1.Id);
        ...
        public async Task ExecuteMissionAsync_WaitingListState()
        {
            #region Arrange
