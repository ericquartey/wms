...
namespace Ferretto.WMS.Data.Tests.Scheduler
{
    ...
    public partial class MissionCreationProviderTest : BaseWarehouseTest
    {
        ...
        [TestMethod]
        public async Task CreateUniquePutMissionCompleteRequest()
        {
            #region Arrange
        ...
        [TestMethod]
        public async Task CreateUniquePutMissionIncompleteRequest()
        {
            #region Arrange
        ...
        [TestMethod]
        public async Task CreateMultiplePutMission()
        {
            #region Arrange
