...
namespace Ferretto.WMS.Data.WebAPI.Contracts
{
    ...
    internal partial class ItemsDataService : ServiceBase, IItemsDataService
    {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<ItemSchedulerRequest> PutAllowedAreaAsync(int id, int areaid, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
