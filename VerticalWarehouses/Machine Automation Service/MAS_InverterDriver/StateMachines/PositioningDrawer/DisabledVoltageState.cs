...
namespace Ferretto.VW.MAS_InverterDriver.StateMachines.PositioningDrawer
{
    public class DisabledVoltageState : IState
    {
        ...
        public DisabledVoltageState(StateMachinePositioningDrawer stateMachinePositioningDrawer, IInverterDriver inverterDriver, IEventAggregator eventAggregator)
        {
                ...
                case MessageStatus.OperationEnd:
                    {
                        ...
                        {
                            this.stateMachinePositioningDrawer.ChangeState(new OperationModeState(stateMachinePositioningDrawer, inverterDriver, eventAggregator));
                        }
                        break;
                    }
