...
namespace Ferretto.VW.MAS_InverterDriver.StateMachines.PositioningDrawer
{
    public class IdleState : IState
    {
        ...
        public IdleState(StateMachinePositioningDrawer stateMachinePositioningDrawer, IInverterDriver inverterDriver,
                ...
                case MessageStatus.OperationEnd:
                {
                    if (result == InverterDriverExitStatus.Success)
                        this.stateMachinePositioningDrawer.ChangeState(
                            new DisabledVoltageState(this.stateMachinePositioningDrawer, this.inverterDriver,
