...
namespace Ferretto.VW.MAS_InverterDriver.StateMachines.HorizontalMovingDrawer
{
    public class ReadyToSwitchOnState : IState
    {
        ...
        public ReadyToSwitchOnState(StateMachineHorizontalMoving stateMachineHorizontalMoving,
                ...
                case MessageStatus.OperationEnd:
                {
                    if (result == InverterDriverExitStatus.Success)
                        this.stateMachineHorizontalMoving.ChangeState(
                            new SwitchOnState(this.stateMachineHorizontalMoving, this.inverterDriver,
