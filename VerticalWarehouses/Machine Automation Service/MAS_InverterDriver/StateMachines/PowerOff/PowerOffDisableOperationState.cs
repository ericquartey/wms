...
namespace Ferretto.VW.MAS_InverterDriver.StateMachines.PowerOff
{
    public class PowerOffDisableOperationState : InverterStateBase
    {
        ...
        public PowerOffDisableOperationState(IInverterStateMachine parentStateMachine, IInverterStatusBase inverterStatus, ILogger logger)
        {
        ...
        public override bool ValidateCommandResponse(InverterMessage message)
        {
            ...
            {
                ParentStateMachine.ChangeState(new PowerOffSwitchOffState(this.ParentStateMachine, this.inverterStatus, this.logger));
                returnValue = true;
            }
