...
namespace Ferretto.VW.MAS_InverterDriver.StateMachines.PowerOff
{
    public class PowerOffErrorState : InverterStateBase
    {
        ...
        public PowerOffErrorState(IInverterStateMachine parentStateMachine, IInverterStatusBase inverterStatus, ILogger logger)
        {
        ...
        public override void Start()
        {
            ...
            Enum.TryParse(inverterStatus.SystemIndex.ToString(), out InverterIndex systemIndex);
