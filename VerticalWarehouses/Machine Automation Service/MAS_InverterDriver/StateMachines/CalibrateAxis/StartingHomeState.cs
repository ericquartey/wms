...
{
    public class StartingHomeState : IState
    {
        #region Fields
        ...
        public StartingHomeState(StateMachineCalibrateAxis stateMachineCalibrateAxis, IInverterDriver inverterDriver, IEventAggregator eventAggregator)
        {
        ...
        public string Type => "Starting Home State";
