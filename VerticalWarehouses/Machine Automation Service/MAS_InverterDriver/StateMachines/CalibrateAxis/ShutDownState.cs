...
namespace Ferretto.VW.MAS_InverterDriver.StateMachines.CalibrateAxis
{
    public class ShutDownState : IState
    {
        ...
        public ShutDownState(StateMachineCalibrateAxis stateMachineCalibrateAxis, IInverterDriver inverterDriver,
            ...
            switch (notification.Status)
            {
                case MessageStatus.OperationEnd:
                {
                    if (result == InverterDriverExitStatus.Success)
                        this.stateMachineCalibrateAxis.ChangeState(new SwitchOnState(this.stateMachineCalibrateAxis,
