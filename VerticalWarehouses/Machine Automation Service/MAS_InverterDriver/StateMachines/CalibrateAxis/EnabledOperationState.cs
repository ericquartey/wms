...
namespace Ferretto.VW.MAS_InverterDriver.StateMachines.CalibrateAxis
{
    public class EnabledOperationState : IState
    {
        ...
        public EnabledOperationState(StateMachineCalibrateAxis stateMachineCalibrateAxis,
                ...
                case MessageStatus.OperationEnd:
                    {
                        if (result == InverterDriverExitStatus.Success)
                            this.stateMachineCalibrateAxis.ChangeState(new StartingHomeState(this.stateMachineCalibrateAxis,
