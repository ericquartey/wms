...
namespace Ferretto.VW.MAS.DataLayer
{
    public interface IBaysDataProvider
    {
        ...
        void SetLaserPointer(BayNumber bayNumber, bool isEnabled, string ipAddress, int port, double xOffset, double yOffset, double zOffsetLowerPosition, double zOffsetUpperPosition);
