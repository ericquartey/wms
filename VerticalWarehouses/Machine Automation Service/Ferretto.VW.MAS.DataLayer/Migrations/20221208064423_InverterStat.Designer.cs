...
namespace Ferretto.VW.MAS.DataLayer.Migrations
{
    ...
    [Migration("20221208064423_InverterStat")]
    partial class InverterStat
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ferretto.VW.MAS.DataModels.InverterStatistics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<double>("AverageActivePower");

                    b.Property<double>("AverageRMSCurrent");

                    b.Property<DateTimeOffset>("DateTime");

                    b.Property<int?>("MachineStatisticsId");

                    b.Property<double>("PeakHeatSinkTemperature");

                    b.Property<double>("PeakInsideTemperature");

                    b.HasKey("Id");

                    b.HasIndex("MachineStatisticsId");

                    b.ToTable("InverterStatistics");
                });
            ...
            modelBuilder.Entity("Ferretto.VW.MAS.DataModels.MachineStatistics", b =>
                {
                    ...
                    b.Property<double>("TotalInverterMissionTime");

                    b.Property<double>("TotalInverterPowerOnTime");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TotalInverterMissionTime = 0.0,
                            TotalInverterPowerOnTime = 0.0,
            ...
            modelBuilder.Entity("Ferretto.VW.MAS.DataModels.InverterStatistics", b =>
                {
                    b.HasOne("Ferretto.VW.MAS.DataModels.MachineStatistics")
                        .WithMany("InverterStatistics")
