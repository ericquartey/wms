...
namespace Ferretto.VW.MAS.DataLayer.Migrations
{
    public partial class horizontalResolutionProcedure : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO SetupProcedures (FeedRate, IsBypassed, IsCompleted, RepeatedTestProcedure_InProgress, performedCycles, requiredCycles, Discriminator) VALUES (1, 0, 0, 0, 0, 25, 'RepeatedTestProcedure')");
