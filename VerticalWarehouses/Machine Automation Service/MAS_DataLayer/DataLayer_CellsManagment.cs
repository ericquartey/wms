...
namespace Ferretto.VW.MAS_DataLayer
{
    public partial class DataLayer : IDataLayerCellManagment
    {
        ...
        public async Task<LoadingUnitPosition> GetFreeBlockPositionAsync(decimal loadingUnitHeight, int loadingUnitId)
        {
            ...
            {
                throw new DataLayerException(DataLayerExceptionEnum.NoFreeBlockBookingException);
            }
        ...
        public LoadingUnitPosition GetLoadingUnitPosition(int cellId)
        {
            ...
            {
                throw new DataLayerException(DataLayerExceptionEnum.CellNotFoundException);
            }
        ...
        public async void SetReturnLoadingUnitInLocation(int loadingUnitId)
        {
            ...
            {
                throw new DataLayerException(DataLayerExceptionEnum.NoFreeBlockBookedException);
            }
