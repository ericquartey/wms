...
{
    internal class PowerOnNordStateMachine : InverterStateMachineBase
    {
        #region Fields
        ...
        public PowerOnNordStateMachine(
            Axis axisToSwitchOn,
        ...
        {
            if (this.CurrentState is PowerOnNordEndState)
            {
        ...
        {
            this.CurrentState = new PowerOnNordStartState(this, this.axisToSwitchOn, this.inverterStatus, this.Logger);
