...
{
    internal class StatisticsEndState : InverterStateBase
    {
        #region Constructors

        public StatisticsEndState(
        ...
        public override void Start()
        {
            ...
            this.Logger.LogDebug($"Statistics End Inverter {this.InverterStatus.SystemIndex}");
