...
namespace Ferretto.VW.MAS.AutomationService.Contracts
{
    ...
    internal partial class MachineElevatorService : ServiceBase, IMachineElevatorService
    {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task MoveToVerticalPositionAsync(decimal targetPosition, decimal? feedRate)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task MoveToVerticalPositionAsync(decimal targetPosition, decimal? feedRate, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (feedRate != null) 
            {
                urlBuilder_.Append("feedRate=").Append(System.Uri.EscapeDataString(ConvertToString(feedRate, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.0.4.0 (NJsonSchema v10.0.21.0 (Newtonsoft.Json v11.0.0.0))")]
    internal partial class MachinePanelsService : ServiceBase, IMachinePanelsService
    {
        private string _baseUrl = "";
        private Ferretto.VW.MAS.AutomationService.Contracts.RetryHttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public MachinePanelsService(string baseUrl, Ferretto.VW.MAS.AutomationService.Contracts.RetryHttpClient httpClient)
        {
            BaseUrl = baseUrl; 
            _httpClient = httpClient; 
            _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(() => 
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/panels");
        ...
        public async System.Threading.Tasks.Task<CellPanel> UpdateHeightAsync(int cellId, decimal newHeight, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/panels/height?");
            urlBuilder_.Append("cellId=").Append(System.Uri.EscapeDataString(ConvertToString(cellId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Append("newHeight=").Append(System.Uri.EscapeDataString(ConvertToString(newHeight, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
