...
namespace Ferretto.VW.MAS.AutomationService.Contracts
{
    ...
    internal partial class MachineEnduranceTestWebService : ServiceBase, IMachineEnduranceTestWebService
    {
        ...
        public MachineEnduranceTestWebService(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl; 
            _httpClient = httpClient; 
            _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(CreateSerializerSettings);
        ...
        /// <exception cref="MasWebApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task StartHorizontalMovementsAsync(int bayPositionId, int loadingUnitId)
        {
            return StartHorizontalMovementsAsync(bayPositionId, loadingUnitId, System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="MasWebApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task StartHorizontalMovementsAsync(int bayPositionId, int loadingUnitId, System.Threading.CancellationToken cancellationToken)
        {
            if (bayPositionId == null)
                throw new System.ArgumentNullException("bayPositionId");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/endurance-test/start/repetitive-horizontal?");
            urlBuilder_.Append(System.Uri.EscapeDataString("bayPositionId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(bayPositionId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Append(System.Uri.EscapeDataString("loadingUnitId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(loadingUnitId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/endurance-test/stop");
