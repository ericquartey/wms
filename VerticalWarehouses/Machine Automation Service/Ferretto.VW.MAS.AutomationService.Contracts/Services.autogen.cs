...
namespace Ferretto.VW.MAS.AutomationService.Contracts
{
    ...
    internal partial class MachineFullTestWebService : ServiceBase, IMachineFullTestWebService
    {
        ...
        {
            return StartAsync(loadunits, cycle, System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="MasWebApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task StartAsync(System.Collections.Generic.IEnumerable<int> loadunits, int cycle, System.Threading.CancellationToken cancellationToken)
        {
            if (cycle == null)
            ...
            urlBuilder_.Append(System.Uri.EscapeDataString("cycle") + "=").Append(System.Uri.EscapeDataString(ConvertToString(cycle, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
