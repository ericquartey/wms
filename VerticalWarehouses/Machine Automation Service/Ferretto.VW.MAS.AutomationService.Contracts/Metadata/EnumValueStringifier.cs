...
namespace Ferretto.VW.MAS.AutomationService.Contracts
{
    public class EnumValueStringifier : IValueStringifier
    {
        public string Stringify(object value)
        {
            ...
            return Ferretto.VW.MAS.AutomationService.Contracts.Metadata.Resources.Vertimag.ResourceManager.GetString(resourceName, System.Globalization.CultureInfo.CurrentCulture) ?? name;
        }
    }
}
