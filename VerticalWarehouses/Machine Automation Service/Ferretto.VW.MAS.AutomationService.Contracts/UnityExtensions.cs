...
namespace Ferretto.VW.MAS.AutomationService.Contracts
{
    public static class UnityExtensions
    {
            ...
            System.Func<IUnityContainer, RetryHttpClient> resolveHttpClientFunction = null)
        {
            ...
            container.GetContainer().RegisterType<IMachinePowerService>(
                new InjectionFactory(c => new MachinePowerService(urlString, resolveFunction(c))));
            ...
            container.GetContainer().RegisterType<IMachineVerticalResolutionCalibrationProcedureService>(
                new InjectionFactory(c => new MachineVerticalResolutionCalibrationProcedureService(urlString, resolveFunction(c))));
            ...
            container.GetContainer().RegisterType<IMachineDepositAndPickupProcedureService>(
                new InjectionFactory(c => new MachineDepositAndPickupProcedureService(urlString, resolveFunction(c))));

            container.GetContainer().RegisterType<IMachineConfigurationService>(
                new InjectionFactory(c => new MachineConfigurationService(urlString, resolveFunction(c))));
