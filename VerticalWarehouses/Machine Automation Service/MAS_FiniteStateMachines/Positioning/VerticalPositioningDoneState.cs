...
namespace Ferretto.VW.MAS_FiniteStateMachines.Positioning
{
    public class VerticalPositioningDoneState : IState
    {
        ...
        public VerticalPositioningDoneState(StateMachineVerticalPositioning parent, INewInverterDriver driver, IEventAggregator eventAggregator)
        {
            ...
            var notifyEvent = new NotificationMessage( null, "Positioning Done", MessageActor.Any, MessageActor.FiniteStateMachines, MessageType.Homing, MessageStatus.OperationEnd, MessageVerbosity.Info);
        ...
        public void Stop()
        {
            var notifyEvent = new NotificationMessage(null, "Positioning Done", MessageActor.Any, MessageActor.FiniteStateMachines, MessageType.Homing, MessageStatus.OpeerationStop, MessageVerbosity.Info);
            this.eventAggregator.GetEvent<NotificationEvent>().Publish(notifyEvent);
        }
