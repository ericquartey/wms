...
namespace Ferretto.VW.MAS.FiniteStateMachines.Homing
{
    public class HomingStartState : StateBase
    {
        ...
        public override void Start()
        {
            ...
            var inverterDataMessage = new InverterSetTimerFieldMessageData(InverterTimer.SensorStatus, true, 100);
            ...
            inverterDataMessage = new InverterSetTimerFieldMessageData(InverterTimer.AxisPosition, true, 250);
            ...
            this.Logger.LogTrace($"4:Publishing Field Command Message {inverterCommandMessage.Type} Destination {inverterCommandMessage.Destination}");
