...
namespace Ferretto.VW.MAS_FiniteStateMachines.Homing
{
    public class HorizontalSwitchDoneState : IState
    {
        ...
        public HorizontalSwitchDoneState(StateMachineHoming parent, INewInverterDriver iDriver,
        ...
        private void notifyEventHandler(NotificationMessage notification)
        {
            switch (notification.Status)
            {
                case MessageStatus.OperationEnd:
                {
                    ...
                    {
                        this.parent.ChangeState(new HorizontalHomingDoneState(this.parent, this.driver,
