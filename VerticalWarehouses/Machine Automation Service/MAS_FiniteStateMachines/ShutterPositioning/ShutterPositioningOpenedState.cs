...
{
    public class ShutterPositioningOpenedState : StateBase
    {
        #region Fields
        ...
        public ShutterPositioningOpenedState(IStateMachine parentMachine, Axis axisToCalibrate, ILogger logger)
        {
