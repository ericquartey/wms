...
{
    public class ShutterPositioningClosedState : StateBase
    {
        #region Fields
        ...
        public ShutterPositioningClosedState(IStateMachine parentMachine, Axis axisToCalibrate, ILogger logger)
        {
