...
{
    public class ShutterPositioningHalfState : StateBase
    {
        #region Fields
        ...
        public ShutterPositioningHalfState(IStateMachine parentMachine, Axis axisToCalibrate, ILogger logger)
        {
