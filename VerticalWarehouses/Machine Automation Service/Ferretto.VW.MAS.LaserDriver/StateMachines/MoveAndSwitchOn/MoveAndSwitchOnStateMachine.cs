...
{
    internal sealed class MoveAndSwitchOnStateMachine : LaserStateMachineBase
    {
        #region Constructors

        public MoveAndSwitchOnStateMachine(
            BayNumber bayNumber,
        ...
        {
            this.ChangeState(new MoveAndSwitchOnStartState(this, this.Logger));
        }
