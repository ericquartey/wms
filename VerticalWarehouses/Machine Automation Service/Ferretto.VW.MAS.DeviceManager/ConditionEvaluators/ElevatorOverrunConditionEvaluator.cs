...
{
    internal class ElevatorOverrunConditionEvaluator : IElevatorOverrunConditionEvaluator
    {
        #region Fields
        ...
        public ElevatorOverrunConditionEvaluator(IMachineResourcesProvider machineResourcesProvider)
        {
