...
{
    internal class ElevatorUnderrunConditionEvaluator : IElevatorUnderrunConditionEvaluator
    {
        #region Fields
        ...
        public ElevatorUnderrunConditionEvaluator(IMachineResourcesProvider machineResourcesProvider)
        {
        ...
        {
            return !this.machineResourcesProvider.IsElevatorUnderrun;
        }
