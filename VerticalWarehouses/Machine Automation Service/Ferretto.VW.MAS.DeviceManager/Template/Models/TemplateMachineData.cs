...
namespace Ferretto.VW.MAS.DeviceManager.Template.Models
{
    internal class TemplateMachineData : ITemplateMachineData
    {
        ...
        public TemplateMachineData(BayNumber requestingBay, BayNumber targetBay, IEventAggregator eventAggregator, ILogger<DeviceManager> logger, IServiceScopeFactory serviceScopeFactory)
        {
