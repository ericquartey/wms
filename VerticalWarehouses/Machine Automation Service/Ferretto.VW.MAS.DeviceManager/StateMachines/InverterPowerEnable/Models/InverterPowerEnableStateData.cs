...
{
    internal class InverterPowerEnableStateData : IInverterPowerEnableStateData
    {
        #region Constructors

        public InverterPowerEnableStateData(IStateMachine parentMachine, IMachineData machineData)
        {
            this.ParentMachine = parentMachine;
            this.MachineData = machineData;
            this.StopRequestReason = StopRequestReason.NoReason;

            this.Message = "InverterPowerEnable State Data";
        }
