...
namespace Ferretto.VW.MAS.DeviceManager.ExtBayPositioning.Models
{
    internal class ExtBayPositioningStateData : IExtBayPositioningStateData
    {
        #region Constructors

        public ExtBayPositioningStateData(IStateMachine parentMachine, IMachineData machineData)
        {
