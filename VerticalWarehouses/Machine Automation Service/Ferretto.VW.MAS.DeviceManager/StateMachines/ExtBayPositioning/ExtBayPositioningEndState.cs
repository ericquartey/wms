...
{
    internal class ExtBayPositioningEndState : StateBase
    {
        #region Fields
                    ...
                    switch (message.Status)
                    {
                        ...
                        case MessageStatus.OperationEnd:
                            ...
                            var notificationMessage = new NotificationMessage(
                                ...
                                this.machineData.MessageData.RequiredCycles == 0 ? "External Bay Positioning Stopped" : "Test Stopped",
        ...
        public override void Start()
        {
            ...
            else
            {
                ...
                var notificationMessage = new NotificationMessage(
                    this.machineData.MessageData,
                    this.machineData.MessageData.RequiredCycles == 0 ? "External Bay Positioning Completed" : "Test Completed",
                    MessageActor.DeviceManager,
                    MessageActor.DeviceManager,
                    MessageType.Positioning,
                    this.machineData.RequestingBay,
                ...
                this.ParentStateMachine.PublishNotificationMessage(notificationMessage);
                this.Logger.LogDebug("FSM ExtBay Positioning End");
            }
