...
{
    internal sealed class ReadyWarehouseRobotStateMachine : IoStateMachineBase
    {
        #region Fields
        ...
        public ReadyWarehouseRobotStateMachine(
            bool enable,
        ...
        {
            this.Logger.LogTrace($"1:Enable ReadyWarehouseRobot={this.enable}");
            ...
            var state = new ReadyWarehouseRobotStartState(this.enable, this.status, this.Logger, this, this.index);
