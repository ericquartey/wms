...
using Ferretto.VW.MAS.IODriver.StateMachines.BayLight;
...
namespace Ferretto.VW.MAS.IODriver
{
    internal partial class IoDevice
    {
        ...
        public void ExecuteBayLight(FieldCommandMessage receivedMessage)
        {
            this.logger.LogTrace("1:Method Start");

            if (receivedMessage.Data is IBayLightFieldMessageData messageData)
            {
                if (this.CurrentStateMachine != null)
                {
                    this.logger.LogError($"ExecuteBayLight: Io Driver already executing operation {this.CurrentStateMachine.GetType().Name}");
                ...
                {
                    this.CurrentStateMachine = new BayLightStateMachine(
                        messageData.Enable,
                        this.ioCommandQueue,
                        this.ioStatus,
                        this.deviceIndex,
