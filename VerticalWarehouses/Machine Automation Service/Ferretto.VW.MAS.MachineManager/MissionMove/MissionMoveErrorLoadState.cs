...
{
    public class MissionMoveErrorLoadState : MissionMoveBase
    {
        #region Constructors

        public MissionMoveErrorLoadState(Mission mission,
        ...
        {
            return this.EnterErrorState(MissionState.ErrorLoad);
        }
