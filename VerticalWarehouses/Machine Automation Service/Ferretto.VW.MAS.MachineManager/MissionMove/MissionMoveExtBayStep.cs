    ...
    public class MissionMoveExtBayStep : MissionMoveBase
    {
        ...
        public override bool OnEnter(CommandMessage command, bool showErrors = true)
        {
            ...
            if (this.Mission.RestoreConditions)
            {
                ...
                this.LoadingUnitMovementProvider.Homing(this.Mission.NeedHomingAxis, Calibration.FindSensor, this.Mission.LoadUnitId, true, false, bay.Number, MessageActor.MachineManager);
            }
            else
            {
