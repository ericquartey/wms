...
{
    internal class CarouselPositioningStartState : StateBase
    {
        #region Fields
        ...
        public CarouselPositioningStartState(IPositioningStateData stateData)
