...
{
    internal class CarouselPositioningErrorState : StateBase
    {
        #region Fields
        ...
        public CarouselPositioningErrorState(IPositioningStateData stateData)
