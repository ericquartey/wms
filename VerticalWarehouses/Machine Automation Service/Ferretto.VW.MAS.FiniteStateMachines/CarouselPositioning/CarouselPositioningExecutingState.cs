...
{
    internal class CarouselPositioningExecutingState : StateBase, IDisposable
    {
        #region Fields
        ...
        public CarouselPositioningExecutingState(IPositioningStateData stateData)
        ...
        ~CarouselPositioningExecutingState()
        {
            this.Dispose(false);
        }
