...
{
    internal class CarouselPositioningStateData : ICarouselPositioningStateData
    {
        #region Constructors

        public CarouselPositioningStateData(IStateMachine parentMachine, IMachineData machineData)
        {
