...
using Prism.Events;
using Prism.Regions;
using VerticalManualMovementsProcedure = Ferretto.VW.MAS.AutomationService.Contracts.VerticalManualMovementsProcedure;
...
namespace Ferretto.VW.App.Installation.ViewModels
{
    internal sealed class ProfileHeightCheckStep2ViewModel : BaseProfileHeightCheckViewModel
    {
        ...
        public Controls.Interfaces.ISensorsService Sensors => this.sensorsService;
