...
{
    internal sealed class ProfileHeightCheckStep6ViewModel : BaseProfileHeightCheckViewModel
    {
        #region Constructors

        public ProfileHeightCheckStep6ViewModel(
        ...
        {
            this.ShowPrevStep(true, true, nameof(Utils.Modules.Installation), Utils.Modules.Installation.ProfileHeightCheck.STEP5);
