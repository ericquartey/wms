...
{
    internal struct ErrorsLoadunitMissingStepAutomaticMode
    {
    }

    internal struct ErrorsLoadunitMissingStepLoadunitOnBay1
    {
    }

    internal struct ErrorsLoadunitMissingStepLoadunitOnBay2
    {
    }

    internal struct ErrorsLoadunitMissingStepLoadunitOnBay3
    {
    }

    internal struct ErrorsLoadunitMissingStepLoadunitOnElevator
    {
    }

    internal struct ErrorsLoadunitMissingStepStart
    {
    }

    internal sealed class ErrorLoadUnitErrorsViewModel : BaseMainViewModel, IDataErrorInfo
    {
        #region Fields
        ...
        private object currentStep = default(ErrorsLoadunitMissingStepStart);
        ...
        public bool HasStepAutomaticMode => this.currentStep is ErrorsLoadunitMissingStepAutomaticMode;

        public bool HasStepLoadunitOnBay1 => this.currentStep is ErrorsLoadunitMissingStepLoadunitOnBay1;

        public bool HasStepLoadunitOnBay2 => this.currentStep is ErrorsLoadunitMissingStepLoadunitOnBay2;

        public bool HasStepLoadunitOnBay3 => this.currentStep is ErrorsLoadunitMissingStepLoadunitOnBay3;

        public bool HasStepLoadunitOnElevator => this.currentStep is ErrorsLoadunitMissingStepLoadunitOnElevator;

        public bool HasStepStart => this.currentStep is ErrorsLoadunitMissingStepStart;
        ...
        public ICommand MoveToNextCommand =>
            ...
            (this.moveToNextCommand = new DelegateCommand(
                () =>
                {
                    if (this.CurrentStep is ErrorsLoadunitMissingStepStart)
                    {
                        //if (this.SensorsService.IsLoadingUnitOnElevator)
                        //{
                        //    this.CurrentStep = default(ErrorsLoadunitMissingStepLoadunitOnElevator);
                        //}
                        ...
                        //{
                        //    this.CurrentStep = default(ErrorsLoadunitMissingStepLoadunitOnBay1);
                        //}
                        ...
                        //{
                        //    this.CurrentStep = default(ErrorsLoadunitMissingStepLoadunitOnBay2);
                        //}
                        ...
                        //{
                        //    this.CurrentStep = default(ErrorsLoadunitMissingStepLoadunitOnBay3);
                        //}
                        //else
                        {
                            this.CurrentStep = default(ErrorsLoadunitMissingStepAutomaticMode);
                        }
                    }
                    else if (this.CurrentStep is ErrorsLoadunitMissingStepLoadunitOnElevator)
                    {
                    ...
                    else if (this.CurrentStep is ErrorsLoadunitMissingStepLoadunitOnBay1)
                    {
                    ...
                    else if (this.CurrentStep is ErrorsLoadunitMissingStepLoadunitOnBay2)
                    {
                    ...
                    else if (this.CurrentStep is ErrorsLoadunitMissingStepLoadunitOnBay3)
                    {
                        this.CurrentStep = default(ErrorsLoadunitMissingStepAutomaticMode);
                    }
                    else if (this.CurrentStep is ErrorsLoadunitMissingStepAutomaticMode)
                    {
        ...
        protected override async Task OnDataRefreshAsync()
        {
            try
            {
                ...
                //    this.LuIdOnBay1Up = this.MachineService.Bays.FirstOrDefault(b => b.Number == BayNumber.BayOne)?.Positions.FirstOrDefault(p => p.IsUpper)?.LoadingUnit?.Id;
                ...
                //    this.LuIdOnBay1Down = this.MachineService.Bays.FirstOrDefault(b => b.Number == BayNumber.BayOne)?.Positions.FirstOrDefault(p => !p.IsUpper)?.LoadingUnit?.Id;
                ...
                //    this.HasBay2PositionUpVisible)
                //{
                //    this.LuIdOnBay2Up = this.MachineService.Bays.FirstOrDefault(b => b.Number == BayNumber.BayTwo)?.Positions.FirstOrDefault(p => p.IsUpper)?.LoadingUnit?.Id;
                ...
                //    this.HasBay2PositionDownVisible)
                //{
                //    this.LuIdOnBay2Down = this.MachineService.Bays.FirstOrDefault(b => b.Number == BayNumber.BayTwo)?.Positions.FirstOrDefault(p => !p.IsUpper)?.LoadingUnit?.Id;
                ...
                //    this.HasBay3PositionUpVisible)
                //{
                //    this.LuIdOnBay3Up = this.MachineService.Bays.FirstOrDefault(b => b.Number == BayNumber.BayThree)?.Positions.FirstOrDefault(p => p.IsUpper)?.LoadingUnit?.Id;
                ...
                //    this.HasBay3PositionDownVisible)
                //{
                //    this.LuIdOnBay3Down = this.MachineService.Bays.FirstOrDefault(b => b.Number == BayNumber.BayThree)?.Positions.FirstOrDefault(p => !p.IsUpper)?.LoadingUnit?.Id;
