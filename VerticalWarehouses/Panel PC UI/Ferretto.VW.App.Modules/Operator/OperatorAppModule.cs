...
namespace Ferretto.VW.App.Modules.Operator
{
    ...
    public class OperatorAppModule : IModule
    {
        ...
        public void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterForNavigation<ChangeLoadUnitFixedView>();
            ...
            containerRegistry.RegisterForNavigation<PtlMessageView>();
            containerRegistry.RegisterForNavigation<InverterDiagnosticsView>();
