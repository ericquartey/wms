...
{
    public partial class CustomControlFullTestLoadingUnitsDataGrid : UserControl
    {
        #region Fields
        ...
        public static readonly DependencyProperty ItemsSourceProperty = DependencyProperty.Register(
            nameof(ItemsSource),
            typeof(IEnumerable),
            typeof(CustomControlFullTestLoadingUnitsDataGrid));
        ...
        public CustomControlFullTestLoadingUnitsDataGrid()
        {
