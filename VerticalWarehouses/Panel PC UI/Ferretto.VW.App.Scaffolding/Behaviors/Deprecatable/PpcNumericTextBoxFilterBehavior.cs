...
{
    public class PpcNumericTextBoxFilterBehavior : PpcTextBoxFilterBehavior
    {
        public static readonly DependencyProperty MinProperty
            = DependencyProperty.RegisterAttached("Min", typeof(double?), typeof(PpcNumericTextBoxFilterBehavior));

        public static readonly DependencyProperty MaxProperty
                    = DependencyProperty.RegisterAttached("Max", typeof(double?), typeof(PpcNumericTextBoxFilterBehavior));

        public static readonly DependencyProperty AllowDecimalsProperty
                    = DependencyProperty.RegisterAttached("AllowDecimals", typeof(bool), typeof(PpcNumericTextBoxFilterBehavior), new PropertyMetadata(false));
