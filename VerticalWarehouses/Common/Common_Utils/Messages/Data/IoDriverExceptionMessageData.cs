...
namespace Ferretto.VW.CommonUtils.Messages.Data
{
    public class IoDriverExceptionMessageData : IIoDriverExceptionMessageData
    {
        ...
        public IoDriverExceptionMessageData(Exception innerException, string exceptionDescription, int exceptionCode, MessageVerbosity verbosity = MessageVerbosity.Debug)
        {
