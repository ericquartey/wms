namespace Ferretto.VW.Common_Utils.Enumerations
{
    public enum InverterSensors
    {
        ...
        AGL_HardwareSensorSTOA = 11,                                   //STO (hardware)
        AGL_HardwareSensorSS1 = 12,                                    //IN1D-SS1 (hardware)
        AGL_ShutterSensorA = 13,                                       //IN2D-Sensore serranda (A)
        AGL_ShutterSensorB = 14,                                       //IN3D-Sensore serranda (B)
        AGL_FreeSensor1 = 15,                                          //IN4D-Libero
        AGL_FreeSensor2 = 16,                                          //IN5D-Libero
        AGL_FreeSensor3 = 17,                                          //MFI1-Libero
        AGL_FreeSensor4 = 18,                                          //MFI2-Libero
        AGL_HardwareSensorSTOB = 19,                                   //STO (hardware)
