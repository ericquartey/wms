...
namespace Ferretto.VW.InstallationApp
{
    public class InstallationAppModule : IModule
    {
        ...
        public InstallationAppModule(IUnityContainer container)
        {
            ...
            var gate1ControlVMInstance = new Gate1ControlViewModel(container.Resolve<IEventAggregator>());
            var gate2ControlVMInstance = new Gate2ControlViewModel(container.Resolve<IEventAggregator>());
            var gate3ControlVMInstance = new Gate3ControlViewModel(container.Resolve<IEventAggregator>());
            var gate1HeightControlVMInstance = new Gate1HeightControlViewModel(container.Resolve<IEventAggregator>());
            var gate2HeightControlVMInstance = new Gate2HeightControlViewModel(container.Resolve<IEventAggregator>());
            var gate3HeightControlVMInstance = new Gate3HeightControlViewModel(container.Resolve<IEventAggregator>());
            ...
            var lSMTGateEngineVMInstance = new LSMTGateEngineViewModel(container.Resolve<IEventAggregator>());
            ...
            var sSGateVMInstance = new SSGateViewModel(container.Resolve<IEventAggregator>());
