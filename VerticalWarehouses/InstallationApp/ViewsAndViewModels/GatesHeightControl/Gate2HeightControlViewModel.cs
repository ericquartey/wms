...
{
    public class Gate2HeightControlViewModel : BindableBase, IViewModel, IGate2HeightControlViewModel
    {
        #region Fields
        ...
        public Gate2HeightControlViewModel(IEventAggregator eventAggregator)
        {
