        ...
        private void ReplyToInverterMessage(TcpClient client, InverterMessage message)
        {
            ...
            switch (message.ParameterId)
            {
                ...
                case InverterParameterId.TorqueCurrent:
                    var torqueMessage = this.FormatMessage(message.ToBytes(), (InverterRole)message.SystemIndex, message.DataSetIndex, BitConverter.GetBytes((ushort)random.Next(40, 140)));
