...
namespace Ferretto.Common.Utils
{
  ...
  {
    private static readonly Regex ViewModelSuffixRegEx = new Regex($"{Common.VIEWMODEL_SUFFIX}$", RegexOptions.Compiled);
    ...
    {
      return !string.IsNullOrEmpty(viewModelName) && viewModelName.EndsWith(Common.VIEWMODEL_SUFFIX, StringComparison.InvariantCulture);
    }
  }
}
