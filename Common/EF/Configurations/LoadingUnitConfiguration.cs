        ...
        public void Configure(EntityTypeBuilder<LoadingUnit> builder)
        {
            ...
            builder.Property(l => l.ReferenceType)
                ...
                .HasConversion(
                    ...
                    charValue => (ReferenceType)Enum.ToObject(typeof(ReferenceType), charValue));
            ...
            builder.Property(l => l.InMissionCount)
                .HasDefaultValue(0);

            builder.Property(l => l.OutMissionCount)
                .HasDefaultValue(0);

            builder.Property(l => l.OtherMissionCount)
                .HasDefaultValue(0);
