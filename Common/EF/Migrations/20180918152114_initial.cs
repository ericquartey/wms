        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassId = table.Column<string>(type: "char(1)", nullable: false),
                    Code = table.Column<string>(nullable: false),
                    CreationDate = table.Column<DateTime>(nullable: false, defaultValueSql: "GETDATE()"),
                    Description = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_AbcClasses_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cradles = table.Column<int>(nullable: true),
                    ...
                    LastPoweOn = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cells_AbcClasses_ClassId",
                        column: x => x.ClassId,
                        principalTable: "AbcClasses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    LoadingUnitTypeId = table.Column<int>(nullable: false),
                    CellPairing = table.Column<int>(nullable: false),
                    Image = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstCellId = table.Column<int>(nullable: false),
                    LastCellId = table.Column<int>(nullable: false),
                    GroupHeight = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CellsGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CellsGroups_Aisles_AisleId",
                        column: x => x.AisleId,
                        principalTable: "Aisles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CellsGroups_Cells_FirstCellId",
                        column: x => x.FirstCellId,
                        principalTable: "Cells",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CellsGroups_Cells_LastCellId",
                        column: x => x.LastCellId,
                        principalTable: "Cells",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LoadingUnits_AbcClasses_ClassId",
                        column: x => x.ClassId,
                        principalTable: "AbcClasses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompartmentTypeId = table.Column<int>(nullable: false),
                    ItemPairing = table.Column<int>(nullable: false),
                    ...
                    LaserPointerCoordinate1 = table.Column<int>(nullable: true),
                    LaserPointerCoordinate2 = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cells_ClassId",
                table: "Cells",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_CellsGroups_AisleId",
                table: "CellsGroups",
                column: "AisleId");

            migrationBuilder.CreateIndex(
                name: "IX_CellsGroups_FirstCellId",
                table: "CellsGroups",
                column: "FirstCellId");

            migrationBuilder.CreateIndex(
                name: "IX_CellsGroups_LastCellId",
                table: "CellsGroups",
                column: "LastCellId");
