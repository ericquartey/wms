...
namespace Ferretto.Common.Controls.WPF.Converters
{
    public class BoolToVisibilityConverter : DependencyObject, IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new InvalidOperationException("Converter can convert only to Visibility Type");
            }
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new InvalidOperationException("Converter can convert only from Visibility Type");
            }
