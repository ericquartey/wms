...
namespace Ferretto.Common.BusinessProviders
{
    public class BayProvider : IBayProvider
    {
        ...
        public Task<IOperationResult<Bay>> AddAsync(Bay model) => throw new NotSupportedException();
        ...
        public Task<IOperationResult<Bay>> SaveAsync(Bay model) => throw new NotSupportedException();
