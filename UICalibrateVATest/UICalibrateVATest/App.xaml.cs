...
using UICalibrateVATest.ViewModels;
using UICalibrateVATest.Views;

namespace UICalibrateVATest
{
    public partial class App : Application
    {
        ...
        static void UnhandledExceptionOccured(object sender, UnhandledExceptionEventArgs args)
        {
            ...
            var path = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)
                                                    + "\\mmorbelli\\UICalibrateVATest\\log.txt";
            ...
            dialogService.ShowMessageBox((INotifyPropertyChanged)(app.DataContext),
                ...
                "If the problem persist, please contact mmorbelli.",
                "Unhandled Error",
                MessageBoxButton.OK);
